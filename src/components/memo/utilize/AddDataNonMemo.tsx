import { Stack, TextField, Text, PrimaryButton } from "@fluentui/react";
	...
	return (
		<Stack tokens={{ padding: 10, childrenGap: 10 }} style={{ border: "1px solid #e0e0e0", margin: 10 }}>
			<Stack horizontalAlign="center">
				<Text variant="xLarge">Not useMemo</Text>
			</Stack>
